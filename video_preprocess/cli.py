...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default="none",
        help=(
            "Rotate every frame at read time before detection. Use 'cw' for "
            "footage stored 90 deg counter-clockwise (this dataset). Frontal "
            "face/eye cascades need upright frames."
        ),
    )
    parser.add_argument(
        "--mean-path",
